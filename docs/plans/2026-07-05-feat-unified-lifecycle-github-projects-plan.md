...
- [ ] Runbook R1–R4 executed and checked off before tagging 3.0.0 *(release gate for the marketplace tag — intentionally open at PR merge; run the four scenarios on the live board before tagging)*
