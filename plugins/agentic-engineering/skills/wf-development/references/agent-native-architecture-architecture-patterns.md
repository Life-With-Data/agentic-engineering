...
See also:
- [files-universal-interface.md](agent-native-architecture-files-universal-interface.md) for file organization and context.md patterns
- [agent-execution-patterns.md](agent-native-architecture-agent-execution-patterns.md) for completion signals and partial completion
- [product-implications.md](agent-native-architecture-product-implications.md) for progressive disclosure and approval patterns
</overview>
...
├── instance/feedback-bot   # reader app feedback bot
