...
| Response | Action |
|----------|--------|
| 1, "design", "architecture", "plan" | Read [architecture-patterns.md](agent-native-architecture-architecture-patterns.md), then apply Architecture Checklist below |
| 2, "files", "workspace", "filesystem" | Read [files-universal-interface.md](agent-native-architecture-files-universal-interface.md) and [shared-workspace-architecture.md](agent-native-architecture-shared-workspace-architecture.md) |
| 3, "tool", "mcp", "primitive", "crud" | Read [mcp-tool-design.md](agent-native-architecture-mcp-tool-design.md) |
| 4, "domain tool", "when to add" | Read [from-primitives-to-domain-tools.md](agent-native-architecture-from-primitives-to-domain-tools.md) |
| 5, "execution", "completion", "loop" | Read [agent-execution-patterns.md](agent-native-architecture-agent-execution-patterns.md) |
| 6, "prompt", "system prompt", "behavior" | Read [system-prompt-design.md](agent-native-architecture-system-prompt-design.md) |
| 7, "context", "inject", "runtime", "dynamic" | Read [dynamic-context-injection.md](agent-native-architecture-dynamic-context-injection.md) |
| 8, "parity", "ui action", "capability map" | Read [action-parity-discipline.md](agent-native-architecture-action-parity-discipline.md) |
| 9, "self-modify", "evolve", "git" | Read [self-modification.md](agent-native-architecture-self-modification.md) |
| 10, "product", "progressive", "approval", "latent demand" | Read [product-implications.md](agent-native-architecture-product-implications.md) |
| 11, "mobile", "ios", "android", "background", "checkpoint" | Read [mobile-patterns.md](agent-native-architecture-mobile-patterns.md) |
| 12, "test", "testing", "verify", "validate" | Read [agent-native-testing.md](agent-native-architecture-agent-native-testing.md) |
| 13, "review", "refactor", "existing" | Read [refactoring-to-prompt-native.md](agent-native-architecture-refactoring-to-prompt-native.md) |
...
**Core Patterns:**
- [architecture-patterns.md](agent-native-architecture-architecture-patterns.md) - Event-driven, unified orchestrator, agent-to-UI
- [files-universal-interface.md](agent-native-architecture-files-universal-interface.md) - Why files, organization patterns, context.md
- [mcp-tool-design.md](agent-native-architecture-mcp-tool-design.md) - Tool design, dynamic capability discovery, CRUD
- [from-primitives-to-domain-tools.md](agent-native-architecture-from-primitives-to-domain-tools.md) - When to add domain tools, graduating to code
- [agent-execution-patterns.md](agent-native-architecture-agent-execution-patterns.md) - Completion signals, partial completion, context limits
- [system-prompt-design.md](agent-native-architecture-system-prompt-design.md) - Features as prompts, judgment criteria

**Agent-Native Disciplines:**
- [dynamic-context-injection.md](agent-native-architecture-dynamic-context-injection.md) - Runtime context, what to inject
- [action-parity-discipline.md](agent-native-architecture-action-parity-discipline.md) - Capability mapping, parity workflow
- [shared-workspace-architecture.md](agent-native-architecture-shared-workspace-architecture.md) - Shared data space, UI integration
- [product-implications.md](agent-native-architecture-product-implications.md) - Progressive disclosure, latent demand, approval
- [agent-native-testing.md](agent-native-architecture-agent-native-testing.md) - Testing outcomes, parity tests

**Platform-Specific:**
- [mobile-patterns.md](agent-native-architecture-mobile-patterns.md) - iOS storage, checkpoint/resume, cost awareness
- [self-modification.md](agent-native-architecture-self-modification.md) - Git-based evolution, guardrails
- [refactoring-to-prompt-native.md](agent-native-architecture-refactoring-to-prompt-native.md) - Migrating existing code
</reference_index>
