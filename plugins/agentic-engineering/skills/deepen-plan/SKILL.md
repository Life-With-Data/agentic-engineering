...
# 3. agentic-engineering plugin skills
ls ~/.claude/plugins/cache/*/agentic-engineering/*/skills/
...
**Important:** Check EVERY source. Don't assume agentic-engineering is the only plugin. Use skills from ANY installed plugin that's relevant.
...
```
mcp__plugin_agentic-engineering_context7__resolve-library-id: Find library ID for [framework]
mcp__plugin_agentic-engineering_context7__query-docs: Query documentation for specific patterns
```
...
# 3. agentic-engineering plugin agents (all subdirectories)
find ~/.claude/plugins/cache/*/agentic-engineering/*/agents -name "*.md" 2>/dev/null
...
- agentic-engineering plugin (but SKIP workflow/ agents - only use review/, research/, design/, docs/)
- ALL other installed plugins (agent-sdk-dev, frontend-design, etc.)
- Any local plugins

**For agentic-engineering plugin specifically:**
