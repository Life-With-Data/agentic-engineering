...
This is the meta-improvement loop for the **compounding engineering** workflow. Where `/workflows:compound` captures the solution to a technical problem, this skill captures *what was missing from the tooling or documentation that let the problem occur in the first place*.
