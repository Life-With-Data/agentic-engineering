...
Quick reference for common testing patterns across the stack. Use alongside the [test-driven-development](test-driven-development.md) reference — the reference covers *when* and *why* (RED-GREEN-REFACTOR, the Prove-It pattern, the double-preference order); this file collects the concrete *how*.
...
For browser verification, use [the browser workflow](test-browser.md) with the
mechanism and environment supplied by the repository capability map.
