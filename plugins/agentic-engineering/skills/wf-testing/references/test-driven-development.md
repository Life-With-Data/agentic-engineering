...
For anything that runs in a browser, unit tests alone are not enough. Use the
repository-approved browser mechanism to inspect user-visible behavior, console
and network evidence, and state changes.
...
For setup and execution mechanics, follow the mapped `development-environment`
and `test-execution` assets; use [browser verification](test-browser.md) for the
...
For detailed testing patterns, examples, and anti-patterns across frameworks, see [testing-patterns.md](test-driven-development-patterns.md).
