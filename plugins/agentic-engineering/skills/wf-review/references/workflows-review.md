...
prove that a review ceremony occurred.
...
Use a concise self-review for routine localized work. Use an independent
reviewer for high-blast-radius, security-sensitive, destructive, cross-cutting,
or explicitly requested work. Multiple reviewer agents are optional and should
have distinct, relevant scopes.
