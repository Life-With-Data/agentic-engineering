...
Note that files in `docs/plans/` and `docs/solutions/` are agentic-engineering pipeline artifacts created by `/workflows-plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
