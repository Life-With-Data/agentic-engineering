...
## [9.4.0](https://github.com/Life-With-Data/agentic-engineering/compare/agentic-engineering-v9.3.1...agentic-engineering-v9.4.0) (2026-09-02)
...
* **plugin:** document the Hermes agent consumption path ([#432](https://github.com/Life-With-Data/agentic-engineering/issues/432)) ([556007d](https://github.com/Life-With-Data/agentic-engineering/commit/556007d8670afe3fc2a19ac1c884c933d7c78bb2)), closes [#430](https://github.com/Life-With-Data/agentic-engineering/issues/430)
...
* **hooks:** add claude-mem session health check ([#278](https://github.com/Life-With-Data/agentic-engineering/issues/278)) ([797ba8f](https://github.com/Life-With-Data/agentic-engineering/commit/797ba8f838e87e91a5c2ddb47cb284e540ac1fa0))
...
* make GitHub issues canonical for lifecycle work ([#238](https://github.com/Life-With-Data/agentic-engineering/issues/238)) ([987f6bb](https://github.com/Life-With-Data/agentic-engineering/commit/987f6bb9246618e9f07e0d070b977fcc14573f11))

## [4.4.1](https://github.com/Life-With-Data/agentic-engineering/compare/agentic-engineering-v4.4.0...agentic-engineering-v4.4.1) (2026-07-20)


### Bug Fixes

* trigger release for consolidated workflows ([#236](https://github.com/Life-With-Data/agentic-engineering/issues/236)) ([55f5d5f](https://github.com/Life-With-Data/agentic-engineering/commit/55f5d5faac6537015abb9ce8b545a8ab1b9a290c))
...
* point to the release-please process from README's Learn more ([#159](https://github.com/Life-With-Data/agentic-engineering/issues/159)) ([0b02eaf](https://github.com/Life-With-Data/agentic-engineering/commit/0b02eafa4ae0329f6658c74be94211c0b4741517))
...
- **README + docs pointed users at the non-canonical `aagnone3/agentic-engineering` fork instead of the canonical origin `Life-With-Data/agentic-engineering`** — the very must-fix the now-working audit tier flagged on its first real run (dogfooding paying off). The marketplace-install command, the `npx github:` install/sync commands, and the CI/Release badges in `README.md`, plus the install snippets and links in `docs/index.html` and `docs/pages/getting-started.html`, and the `repository` field in the plugin manifests, all named the personal fork and misdirected the install path. Repointed to `Life-With-Data`. Deliberately left untouched: the author's personal profile URL (`author.url` → `github.com/aagnone3`, which is correct — the author *is* aagnone3), historical CHANGELOG entries, and the recorded `gh` test fixtures / fork-trap tests that use `aagnone3` as their simulated-origin scenario.
...
- **`block-beads-jsonl-stage` operational guard hook ported from `agent-leverage`** (PreToolUse/Bash, wired in `plugin.json`, with a unit test): blocks staging the passive `.beads/*.jsonl` Beads export so the local scratchpad never lands in git (PR #38, issue #57).
