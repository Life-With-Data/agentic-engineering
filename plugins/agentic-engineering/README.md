...
suppresses routine check-ins, keeps correctness gates, and reaches out only for
a genuine blocker or missing authority. Ordinary runs require the human
`ready_for_work` approval.
