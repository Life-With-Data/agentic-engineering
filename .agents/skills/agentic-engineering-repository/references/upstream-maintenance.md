...
`agentic-engineering-repository` skill to maintain this checkout's committed
upstream registry.
...
> This issue body is machine-generated by the repository upstream-maintenance route and fully regenerated on
...
**Writer contract:** this repository-maintenance route performs exactly one transition per new report issue: `→ stub`.
